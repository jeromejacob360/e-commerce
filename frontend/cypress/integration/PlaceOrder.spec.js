...
describe('Trying to place an order', () => {
  ...
  /////////////////////////////////
  it('should add an item to cart ivf the cart is empty', () => {
    cy.get('[data-testid="LocalMallIcon"]').click();
    cy.url()
      .should('include', 'cart')
      .get('body')
  ...
  ////////////////////
  it('should add ans item to cart if the cart is empty', () => {
    cy.get('[data-testid="LocalMallIcon"]').click();
    cy.url()
      .should('include', 'cart')
      .get('body')
  ...
  ///////////////////
  it('should asdd an item to cart if the cart is empty', () => {
    cy.get('[data-testid="LocalMallIcon"]').click();
    cy.url()
      .should('include', 'cart')
      .get('body')
